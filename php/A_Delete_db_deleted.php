...
<body onload="display_ct()" class="body">
    ...
    <div style="width: 50vw; text-align: center; color: aqua; background-color: black;padding: 0 1% 0 1%; margin:1% auto; border: solid gray 5px; border-radius: 25px;">
        ...
        $delete = "DELETE FROM registration WHERE id = '$idno'";
        $result = mysqli_query($sql, $delete);

        if ($result) {
            echo "<h3> Member information successfully deleted.</h3>";
        } else {
            echo "<h3>Oops..! <br/> Error in deleting member information.</h3>";
        }
        ?>
    </div>
